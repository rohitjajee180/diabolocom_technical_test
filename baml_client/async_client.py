...
class BamlAsyncClient:
    ...
    async def ClassifyTextByTheme(
      ...
      return cast(types.ThemeClassification, raw.cast_to(types, types, partial_types, False))
    
    async def ExtractCustomerInformation(
        self,
        conversation: str,
        baml_options: BamlCallOptions = {},
      ...
      return cast(types.CustomerInformation, raw.cast_to(types, types, partial_types, False))
    
    async def ExtractFormInformation(
        self,
        conversation: str,schema: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      ...
      raw = await self.__runtime.call_function(
        ...
        {
          "conversation": conversation,"schema": schema,
        },
        self.__ctx_manager.get(),
        tb,
        __cr__,
...
class BamlStreamClient:
    ...
    def ClassifyTextByTheme(
        ...
        query: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.ThemeClassification, types.ThemeClassification]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.ThemeClassification, types.ThemeClassification](
        raw,
        lambda x: cast(partial_types.ThemeClassification, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.ThemeClassification, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
    ...
    def ExtractCustomerInformation(
        ...
        conversation: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.CustomerInformation, types.CustomerInformation]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.CustomerInformation, types.CustomerInformation](
        raw,
        lambda x: cast(partial_types.CustomerInformation, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.CustomerInformation, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
